...
struct spi_info spi_info_table[] = {
	...
	*/
	...
	{"MX25L25635E", {0xc2, 0x20, 0x19}, 3, _32M, _64K, 4,
		{&READ_STD(0, INFINITE, 40/*50*/), &READ_FAST(1, INFINITE, 64/*80*/), &READ_DUAL_ADDR(1, INFINITE, 56/*70*/), /*&READ_QUAD_ADDR(2, INFINITE, 56),*/ 0},
	...
	{"S25FL129P0", {0x01, 0x20, 0x18, 0x4d, 0x00}, 5, (_256K * 64),  _256K, 3,
		{&READ_STD(0, INFINITE, 40),&READ_FAST(1, INFINITE, 104), &READ_DUAL(1, INFINITE, 80), &READ_DUAL_ADDR(1, INFINITE, 80),/*&READ_QUAD(1, INFINITE, 80), &READ_DUAL_ADDR(0, INFINITE, 80), &READ_QUAD_ADDR(3, INFINITE, 80), */0},
		{&WRITE_STD(0, 256, 104), /*&WRITE_QUAD(0, 256, 80),*/ 0},
		{&ERASE_SECTOR(0, SPI_IF_ERASE_SECTOR, 104), 0}},

	{"S25FL129P1", {0x01, 0x20, 0x18, 0x4d, 0x01}, 5, (_64K * 256),  _64K,  3,
		{&READ_STD(0, INFINITE, 40),&READ_FAST(1, INFINITE, 104), &READ_DUAL(1, INFINITE, 64), &READ_DUAL_ADDR(1, INFINITE, 80),/*&READ_QUAD(1, INFINITE, 80), &READ_DUAL_ADDR(0, INFINITE, 80), &READ_QUAD_ADDR(3, INFINITE, 80),*/ 0},
		{&WRITE_STD(0, 256, 104),/* &WRITE_QUAD(0, 256, 80),*/ 0},
		{&ERASE_SECTOR(0, SPI_IF_ERASE_SECTOR, 104), 0}},
